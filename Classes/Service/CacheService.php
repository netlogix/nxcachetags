...
class CacheService extends AbstractService implements SingletonInterface
{
    ...
    public const CACHE_ARGUMENT_CONTENT = 'c';
    public const CACHE_ARGUMENT_TAGS = 't';
    public const CACHE_ARGUMENT_LIFETIME = 'l';
    ...
    public function render(
        ...
        foreach ($identifiedBy as $identifierConfiguration) {
            ...
            $identifierPart = $this->cacheTagService->createCacheIdentifier(
        ...
        if (!$this->getTyposcriptFrontendController()->headerNoCache() && $this->cache->has($identifier)) {
            ...
            $this->cacheTagService->addEnvironmentCacheTags(
                $this->cacheTagService->findTableCacheTagsForLifetimeSources(
                    $lifetimeSource,
                    $identifierSourceParts
                )
            );
            ...
            $this->cache->set(
                $identifier,
                $cacheData,
                $cacheData[self::CACHE_ARGUMENT_TAGS],
